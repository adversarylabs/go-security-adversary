...
import type { Analysis, Signal } from "./types.js";

/**
 * Uses the CLI-built repository index to attach importer navigation for
 * security signals (who imports a package that carries a finding).
 */
...
/** Exported for unit tests — resolves importers of a Go file via package dir + file path. */
